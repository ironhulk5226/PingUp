...
const Notification = ({t,message}) => {
  ...
  return (
    <div className='max-w-md bg-white shadow-lg rounded-lg flex border border-gray-300 hover:scale-105 transition'>
        ...
        <div className='flex border-1 border-gray-200'>
          ...
          onClick={()=>{
            ...
            toast.dismiss(t.id) // t is the toast instance and t.id -> toast id
          }}
