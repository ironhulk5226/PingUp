            ...
            <div>
                <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
                    ...
                    <div>
                        ...
                        <p>Used by 23k+ developers</p>
                    </div>

                </div>
                    <h1 className='text-3xl md:text-6xl md:pb-2 bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent '>More than just truly connect</h1>
                    <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>connect with global community on pingup.</p>
            </div>
            <span className='md:h-10'></span>
        </div>
        {/* right side : Login form (using inbuilt components of clerk)*/}
